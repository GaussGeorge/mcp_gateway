...
\texttt{cloudlab\_p3\_small\_random\_redis\_cp\_v2} & CloudLab validation summaries & Random routing with Redis checkpoint/reservation state; 843 cross-node sessions, zero state misses, zero duplicate admissions. \\
