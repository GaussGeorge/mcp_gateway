...
DEPRECATED: This script uses the old N=9 (no neutral-row filter) logic and reads up to run9.
Use scripts/_compute_bursty_stats.py (N=7, neutral rows excluded, first-valid-row-per-run)
for all paper-facing numbers. This file is kept for historical reference only.
"""
