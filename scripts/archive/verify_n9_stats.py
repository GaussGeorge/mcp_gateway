"""Verify N=7 bursty experiment statistics against paper claims."""
...
metrics = [
    ("PARTIAL", ng_partial, pg_partial, "94+-14", "76+-12", "-19%", "t(12)=2.73, p<0.02"),
    ("Cascade", ng_cascade, pg_cascade, "174+-38", "143+-25", "-18%", "one-tailed t(12), p<0.05"),
    ("Rej0", ng_rej0, pg_rej0, "86+-15", "108+-12", None, "t(12)=3.13, p<0.01"),
