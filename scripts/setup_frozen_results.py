...
COPY_MAP = [
    ...
    ("manifests",                    "manifests"),
    # New in v9: tput-latency, proxy baselines, multigateway shared state, gateway overhead
    ("exp_tput_latency",             "exp_tput_latency"),
    ("exp_proxy_baselines",          "exp_proxy_baselines"),
    ("exp_multigateway_shared_state_full", "exp_multigateway_shared_state_full"),
    ("exp_gateway_overhead",         "exp_gateway_overhead"),
